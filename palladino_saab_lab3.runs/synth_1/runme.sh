...
HD_PWD='C:/Users/Nick Palladino/Documents/Vivado Projects/palladino_saab_lab3/palladino_saab_lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log computer_bus.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source computer_bus.tcl
