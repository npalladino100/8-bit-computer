...
HD_PWD='C:/Users/Nick Palladino/Documents/Vivado Projects/palladino_saab_lab3/palladino_saab_lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log computer_bus.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source computer_bus.tcl -notrace
